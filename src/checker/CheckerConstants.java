...
public final class CheckerConstants {
    ...
    public static final String USE_HERO_ABILITY = "use_hero_ability";
    public static final String BIG_GAME = "big_game";
    public static final Integer GAME_START_POINTS = 4;
    public static final Integer SINGLE_GAME_POINTS = 5;
    public static final Integer MULTIPLE_GAMES_VALID_POINTS = 5;
    public static final Integer MULTIPLE_GAMES_INVALID_POINTS = 5;
    public static final Integer USE_HERO_ABILITY_POINTS = 4;
